...
import sys
import time
from source import UserInterface
import string
import operator
...
def showDatasetfromImage(image, string, DataSetFrame,gui):  # parametre olarak sleep alabilir
...
#                                      self.gui.DatasetFrame)  ##burda cagırınca 0.3 saniye bekliyor ondan acılmıyor entry
...
#
#        self.showDatasetfromImage(self.gray_image, "Gray Image",
#                                  self.gui.DatasetFrameMatch)  # parametre olarak sleep alabşlirm
...
#
#            self.showDatasetfromImage(self.image, "Image Segmentation",
#                                      self.gui.DatasetFrameMatch)  # burda bekleme yok mesela onun için başka parametre yazailbir
